...
import 'package:sruzy/screens/arama.dart';

class AramaProfil extends StatefulWidget {
  final String id;
  AramaProfil({Key key, @required this.id}) : super(key: key);

  static String tag = 'arama_profil';
  @override
  _AramaProfilState createState() => _AramaProfilState();
}

class _AramaProfilState extends State<AramaProfil> {
  List data;
  ...
  Future<String> getProfil(String id) async {
  ...
  Future _sendID() async {
    ...
    var url = 'http://sametozyurek.com.tr/databases/takip.php';
